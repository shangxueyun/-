...
;(function() {
  var resList = {
    ...
    js: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/js/china.js',
      ...
      window.SITE_CONFIG.cdnUrl + '/static/js/bim/jq.js',
      window.SITE_CONFIG.cdnUrl + '/static/js/bim/3dEngine.js',
      window.SITE_CONFIG.cdnUrl + '/static/webVideoCtrl/webVideoCtrl.js',
      // 业务
      ...
      // window.SITE_CONFIG.cdnUrl + '/static/webVideoCtrl/demo.js'
