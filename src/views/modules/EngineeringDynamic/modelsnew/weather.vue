<template>
  <div class="rd-weather">
    <div class="rd-1 Me_one" :style="cssStyle.Me_one">
      <div class="top">
        <!-- {{weatherResultItem.reporttime.split(' ')[0]}} -->
  ...
  export default {
    data () {
      return {
        ...
        cssStyle: {
          Me_one: {width: '100%', marginBottom: '1rem', marginRight: '10px'},
          Me_two: {width: '100%', marginBottom: '1rem'}
        },
        reporttime:'',
        city:'',
        temperature:'',
    ...
    methods: {
      init (data){
        ...
        this.reporttime = this.weatherResultItem.reporttime
        this.city = this.weatherResultItem.city

        let date = new Date(this.reporttime.replace(/-/g, "/"));
        let seperator1 = "-";
        ...
        this.reporttime = year + '年' + month + '月' + strDate + '日'

        // console.log("this.weatherResultItem",this.weatherResultItem.casts[0])
        this.temperature = this.weatherResultItem.casts[0].daytemp
        this.dayweather = this.weatherResultItem.casts[0].dayweather
