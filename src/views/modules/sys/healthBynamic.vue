<template>
  <div class="healthBynamic" :style="{height:offHeight}" v-loading="healthBynamicLoading">
    <el-button type="primary" class="Btn" @click="exit">返回</el-button>
