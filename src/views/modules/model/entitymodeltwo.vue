...
<script>
    ...
    export default {
        ...
        activated () {
            ...
            // 模型数据
            var modelList = new Array("http://222.184.237.179:8088/14BIM0919/14BIM0919List.json");
            // var modelList = new Array("");
            console.log("222",modelList)
...
//              ResetClip();
            ...
            loadNode1(node, resolve) {
                  ...
                  if (node.level == 1) {
                      ...
                      this.$http({
                            url: this.$http.adornUrl('/bim/tree/getPropertyTypeData/8'),
                            method: 'get',
                            params: this.$http.adornParams({
                                // 'MileageID': 6
                            })
