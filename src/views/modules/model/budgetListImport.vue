  ...
  <div class="contains" >
    <div  class="header" >
      ...
      <template v-if="checkNum===2">
        <el-button  type="warning"  @click="addOrUpdateHandleExcel">修改</el-button>
        <el-button  type="danger"   @click="deleteHandle">删除</el-button>
        <el-button  type="primary"  @click="importExcelFun">导出计划清单</el-button>
        <el-button type="primary"  @click="assOrUpdateHandle" >关联模型</el-button>
        <el-button type="danger"  @click="removeOrUpdateHandle" v-if="rowStatus==1">取消关联</el-button>
      </template>
            </el-form-item>
       </el-form>
