  ...
  export default {
    ...
    methods: {
      ...
      getDataList (num) {
        ...
        this.$http({
          url: this.$http.adornUrl('/bim/problemType/rootNodePage'),
          method: 'post',
      ...
      load(tree, treeNode, resolve) {
        ...
        if(tree.hasChildren == 1){
            this.$http({
              url: this.$http.adornUrl('/bim/problemType/childrenNodes/'+tree.id),
              method: 'POST',
      ...
      updatenameHandle(){
        ...
        this.$nextTick(() => {
          this.$refs.updatename.init(rows.name,rows.id)
        })
      ...
      subordinateHandle(){
        ...
        this.$nextTick(() => {
          this.$refs.updatesa.init(rows.type,rows.id)
        })
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定进行[${ids.id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/bim/problemType/delete'+'/'+ids.id),
            method: 'post',
