...
<el-row :gutter="20">
  <el-col :span="8">
            <el-form-item label="检查结果" prop="results" label-width="80px">
                  <el-select v-model="dataForm.results" width=100% clearable placeholder="请选择检查结果">
                    <el-option
  ...
  <el-col :span="16">
            <el-form-item label="创建时间区间" prop="creationtimes" label-width="145px">
                  <el-date-picker
            ...
            <el-form-item label="状态变更时间区间" prop="updatetimes" label-width="145px">
                  <el-date-picker
