...
<script>
  import SiteDetails from './quality-details'
  export default {
      data () {
          return {
              options:[
      ...
      methods: {
          ...
          safetyProblem(){
            this.$http({
                url: this.$http.adornUrl('/bim/qualityProblem/listQualityProblemRegions'),
                method: 'post',
          ...
          getDataList(num){
            ...
            this.$http({
              url: this.$http.adornUrl('/bim/qualityProblem/listPg'),
              method: 'post',
              data: this.$http.adornParams({
